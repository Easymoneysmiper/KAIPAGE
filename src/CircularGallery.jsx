...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    ...
    let galleryItemsList = [...galleryItems];
    while (galleryItemsList.length > 0 && galleryItemsList.length < 8) {
      galleryItemsList = galleryItemsList.concat(galleryItemsList);
    }
    this.mediasImages = galleryItemsList;
