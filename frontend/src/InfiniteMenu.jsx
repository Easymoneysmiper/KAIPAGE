...
export default function InfiniteMenu({ items = [], scale = 1.0, isActive = false }) {
  ...
  const handleButtonClick = () => {
    ...
    if (activeItem.link.startsWith('http')) {
      ...
      activeItem.link.startsWith('mailto:') ||
      activeItem.link.startsWith('weixin:') ||
      activeItem.link.startsWith('tencent:')
    ) {
